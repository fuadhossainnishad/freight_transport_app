...
const MyDriversScreen = () => {
    ...
    const fetchDrivers = useCallback(async () => {
        try {
            ...
            console.log(err);
            Alert.alert("Error", "Failed to load your drivers. Please try again.");
        } finally {
            setLoading(false);
            setRefreshing(false);
        }
    ...
    return (
        <SafeAreaView edges={["top"]} className="flex-1 bg-gray-50">
            <AppHeader text="My Drivers" onpress={() => navigation.goBack()} />
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View className="flex-1 items-center justify-center px-8 py-20">
                            ...
                            <Text className="text-base font-semibold text-gray-900">No drivers yet</Text>
                            <Text className="text-sm text-gray-500 text-center mt-1.5 leading-5">
                                Add your first driver to start assigning them to shipments.
                            </Text>
                        </View>
                    }
                />
            ...
            <View className="px-4 pt-2 pb-4 bg-gray-50">
                ...
                >
                    ...
                    <Text className="text-white text-center font-semibold text-base">Add Driver</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
